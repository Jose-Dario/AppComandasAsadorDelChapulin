...
public class ComandasFragment extends Fragment {
    ...
    public static AdapterComandas adapterComandas;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view= inflater.inflate(R.layout.fragment_comandas, container, false);
        adapterComandas.setView(view);
        gridView=view.findViewById(R.id.contenedorComandas);
        gridView.setAdapter(adapterComandas);
        return view;
    }
}