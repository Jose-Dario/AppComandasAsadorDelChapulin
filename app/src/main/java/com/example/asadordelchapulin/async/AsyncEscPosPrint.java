package com.example.asadordelchapulin.async;
...
public abstract class AsyncEscPosPrint extends AsyncTask<AsyncEscPosPrinter, Integer, AsyncEscPosPrint.PrinterStatus> {
    ...
    protected void onPreExecute() {
        if (this.dialog == null) {
            ...
            this.dialog.setTitle("Impresión en proceso...");
    ...
    protected void onProgressUpdate(Integer... progress) {
        switch (progress[0]) {
            case AsyncEscPosPrint.PROGRESS_CONNECTING:
                this.dialog.setMessage("Conectando a la impresora...");
                break;
            ...
            case AsyncEscPosPrint.PROGRESS_PRINTED:
                this.dialog.setMessage("Impresión finalizada...");
                break;
        }
